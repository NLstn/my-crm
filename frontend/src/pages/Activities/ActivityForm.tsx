...
import type { Activity, Account, Contact, Employee, Lead } from '../../types'
...
export default function ActivityForm() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    if (e.target.name === 'AccountID' || e.target.name === 'ContactID' || e.target.name === 'EmployeeID' || e.target.name === 'LeadID') {
